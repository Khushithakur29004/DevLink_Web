  ...
  return (
    <div className=' text-center my-10'>
        ...
        {requests.map((request)=>{
           ...
           return (
           <div key={_id} className=' flex justify-between items-center m-4 p-4 rounded-lg bg-base-300 w-3/4  mx-auto  '>
            <div>
            ...
            <div className='text-left mx-4'>
               ...
               {age && gender && <p>{age+ ", " + gender}</p>}
                ...
                <div>
                    ...
                    <button className="btn btn-secondary mx-2 my-1" onClick={()=>reviewRequest("accepted",request._id)}>Accept</button>
                </div>
